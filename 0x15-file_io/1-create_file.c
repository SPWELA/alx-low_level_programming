...
* *@createdfile: the function accepts an input saved into filename
* *@text_content: letters is the number of letters it should read and print
* Return: Success (1)
*/

int create_file(const char *createdfile, char *text_content)
{
	int toOpen, toWrite;
	int contentLen = 0;
	...
	/* Opening of the file */
	toOpen = open(createdfile, O_CREAT | O_RDWR | O_TRUNC, 0600);
